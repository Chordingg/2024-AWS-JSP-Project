    ...
    <div id="wrap" align="center">
        ...
        <form name="frm" method="post" id="paymentForm">
            ...
            <table>
                ...
                <tr>
                    <th>이메일</th>
                    <td><input type="text" size="40" name="title" value="${loginUser.email}" ></td>
                </tr>
                <tr>
                    <th>우편번호(주소)</th>
                    <td><input type="text" size="40" name="title" value="${loginUser.addr}" > * 필수</td>
                </tr>
                <tr>
                    <th>상세 주소</th>
                    <td><input type="text" size="40" name="title" value="${loginUser.addr2}" > * 필수</td>
                </tr>
                <tr>
                    <th>총합 가격</th>
            ...
            <input type="reset" value="이 전(장바구니)"
                onclick="location.href='ProServlet?command=order_list&id=${loginUser.id}'">
