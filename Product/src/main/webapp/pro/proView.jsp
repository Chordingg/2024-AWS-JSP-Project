...
<body>
	...
	<div class="project" align="center">
		<img src="${pageContext.request.contextPath}/upload/${pro.img}"
			alt="상품 이미지">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<input type="button" class="button" value="바로 구매하기"
								onclick="location.href='ProServlet?command=order_pay1_form'">
							<input type="button" class="button" value="장바구니"
								onclick="location.href='ProServlet?command=cart_add&pid=${pro.pid}&id=${loginUser.id}&pname=${pro.pname }&price=${pro.price }&stock=${pro.stock }'">
