	...
	<div id="wrap" align="center">
		...
		<form name="frm" method="post" action="UserServlet">
			...
			<table>
				...
				<tr>
					<th>이메일</th>
					<td><input type="text" size="30" maxlength="50" name="email"
						value="${user.email}"></td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input type="password" size="12" name="pass"><br> * 필수
						(게시물 수정 삭제시 필요합니다.)</td>
				</tr>
				<tr>
					<th>주소</th>
					<td><input id="member_post" type="text" placeholder="우편번호"
						name="postcode" readonly><br>
						 <input id="member_addr" type="text" placeholder="주소" name="addr" readonly><br>
						 <input id="member_addr2" type="text" placeholder="상세주소" name="addr2"><br>
